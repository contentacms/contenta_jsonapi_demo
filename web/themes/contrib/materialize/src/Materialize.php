...
class Materialize {
  ...
  /**
   * Matches a Materialize Glyphicon based on a string value.
   *
   * @param string $value
   ...
   *
   * @return string
   *   The Materialize icon matched against the value of $haystack or $default if
