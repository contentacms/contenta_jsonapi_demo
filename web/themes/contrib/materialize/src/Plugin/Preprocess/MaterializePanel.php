...
/**
 * Pre-processes variables for the "materialize_panel" theme hook.
 *
 * @ingroup plugins_preprocess
 *
 * @MaterializePreprocess("materialize_panel")
 */
class MaterializePanel extends PreprocessBase implements PreprocessInterface {
  ...
  protected function preprocessVariables(Variables $variables) {
    ...
    $id = $variables->getAttribute('id', Html::getUniqueId($variables->offsetGet('id', 'materialize-panel')));
    unset($variables['id']);
