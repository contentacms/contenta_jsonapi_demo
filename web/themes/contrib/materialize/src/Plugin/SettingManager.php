...
/**
 * Manages discovery and instantiation of Materialize theme settings.
 *
...
class SettingManager extends PluginManager {
  ...
  public function __construct(Theme $theme) {
    parent::__construct($theme, 'Plugin/Setting', 'Drupal\materialize\Plugin\Setting\SettingInterface', 'Drupal\materialize\Annotation\MaterializeSetting');
